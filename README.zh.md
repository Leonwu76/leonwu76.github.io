...
**[在这里预览模板 &rarr;](http://www.nnbit.com/huxblog-boilerplate/)**
...
```
# Site settings
title: Leon Wu             # 你的博客网站标题
SEOTitle: Leon Wu			# 在后面会详细谈到
...
ga_domain: www.nnbit.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“Leon Wu”** 但是我想要在搜索的时候显示 **“LeonWu的博客 | Leon Wu”** ，这个就需要SEO Title来定义了。
