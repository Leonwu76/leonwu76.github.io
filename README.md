...
###[View Live Leon Wu &rarr;](https://www.nnbit.com)

![](http://www.nnbit.com/img/blog-desktop.jpg)
...
**[View Boilerplate Here &rarr;](http://www.nnbit.com/huxblog-boilerplate/)**
...
<img src="http://www.nnbit.com/img/blog-md-navbar.gif" width="320" />
...
```
# Site settings
title: Leon Wu             # title of your website
SEOTitle: Leon Wu			# check out docs for more detail
...
![](http://www.nnbit.com/img/blog-sidebar.jpg)
...
![](http://www.nnbit.com/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://www.nnbit.com/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“Leon Wu”** but I want the title shows in search engine is **“LeonWu的博客 | Leon Wu”** which is multi-language.
...
Leon Wu is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
